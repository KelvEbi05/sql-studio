const CACHE='sql-studio-pages-v3';const FILES=['./','index.html','style.css','app.js','lessons.js','worker.js','tsql.js','manifest.webmanifest','icon.svg','sql-wasm.js','sql-wasm.wasm'];
